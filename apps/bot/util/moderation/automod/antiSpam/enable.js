 ...
 if (createdRule) {
   ...
   actions: [
    {
     ...
     metadata: {
      ...
      customMessage: "Message blocked due to detected spam. Rule added by Kepler",
     },
    },
   ],
  ...
  if (logChannel) {
   ...
   ruleToCreate.actions.push({
    ...
    metadata: {
     channel: logChannel,
     message: "Message blocked due to detected spam. Rule added by Kepler",
    },
   });
  }
