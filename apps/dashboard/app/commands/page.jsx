...
export const metadata = {
 title: "Commands",
 description: "A list of all the commands available for Kepler.",
};
 ...
 return (
  <div className="flex w-full flex-col items-center px-8 pb-8 pt-16 antialiased md:px-16 md:py-16">
   <div className="flex flex-col justify-center gap-4">
    <Image src={dashboardConfig.logo} alt="Kepler logo" quality={100} width={112} height={112} className="mx-auto h-28 min-h-28 w-28 min-w-28 rounded-full" />
    <Header1 className="text-fill-transparent !mb-0 !justify-center bg-gradient-to-b from-white	to-neutral-400 box-decoration-clone bg-clip-text !text-center !font-black">Kepler Commands</Header1>
    <p className="max-w-3xl text-center text-xl text-white/50">
     <Balancer>
      Check out all the commands available for Kepler. There are currently <span className="text-accent-primary">{newCommands.length}</span> commands in <span className="text-accent-primary">{categories.length}</span> categories.
     </Balancer>
    </p>
   </div>
