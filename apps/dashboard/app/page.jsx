import { dashboardConfig, globalConfig } from "@kepler/config";
import prismaClient from "@kepler/database";
import { formatNumber } from "@kepler/util/functions/util";
   ...
   <div className="before:md:bg-grid-[#fff] relative z-20 flex min-h-screen w-full items-center justify-center before:absolute before:z-10 before:h-full before:w-full before:opacity-5 before:grayscale">
    ...
    <div className="relative z-20 -mt-8 flex w-full select-none flex-col items-center justify-center gap-4 px-3 md:w-[90%]">
     ...
     <Header2 className="mb-0 max-w-[680px] text-center font-normal text-white/70">
      <Balancer>Kepler will not only keep your server entertained but also assist you with moderation and many other things!</Balancer>
     </Header2>
    ...
    <div className="mx-auto pb-10 md:px-8 lg:px-16 xl:w-4/5">
     ...
     <div className="mx-auto flex w-full flex-col gap-4 px-4 md:grid md:grid-cols-2 lg:grid-cols-3">
       ...
       <div className="mt-3">
        <div className="flex flex-row items-center gap-1">
         ...
         <span className="text-xs">
          <span className="font-bold">Kepler</span> used <span className="text-accent-primary font-bold">/ai</span>
         </span>
        </div>
      ...
      <div className="bg-background-secondary row-span-1 overflow-hidden rounded-xl border border-neutral-800 p-4 duration-200 hover:bg-neutral-800/50">
       ...
       <p className="mt-2 max-w-[680px] text-white/70">Kepler has a leveling system that will keep your members active and entertained.</p>
      ...
      <div className="bg-background-secondary relative col-span-2 row-span-2 overflow-hidden rounded-xl border border-neutral-800 px-8 py-6 duration-200 hover:bg-neutral-800/50 lg:col-span-1">
       ...
       <div className="relative z-10">
        <p className="mt-2 max-w-[680px] text-white/70">
         <Balancer>Someone's breaking the rules? You can easily enable Auto-Moderation and Kepler will take care of the rest!</Balancer>
        </p>
        <div className="mt-3 flex flex-row items-center gap-1">
         ...
         <span className="ml-2">
          <span className="font-bold">Kepler</span> banned <span className="text-accent-primary font-bold">Krushna V.</span> 🔨
         </span>
        </div>
        <div className="mt-3 flex flex-row items-center gap-1">
         ...
         <span className="ml-2">
          <span className="font-bold">n0step_</span> enabled <span className="text-accent-primary font-bold">Auto-Moderation</span> ⚙️
         </span>
        </div>
       ...
       <div className="relative z-50 h-full">
        <div className="px-8 py-6">
         ...
         <p className="max-w-[680px] text-white/70">
          <Balancer>With Kepler you can get to know your server better with the help of the dashboard. You can see the most active members, the most used channels and activity graphs!</Balancer>
         </p>
        </div>
      ...
      <div className="bg-background-secondary relative col-span-2 row-span-1 overflow-hidden rounded-xl border border-neutral-800 px-8 py-6 duration-200 hover:bg-neutral-800/50 lg:col-span-1">
       ...
       <p className="mt-2 max-w-[680px] text-white/70">Want to host a giveaway or a drop? Kepler can help you with that! You can easily create and moderate giveaways with few simple commands!</p>
