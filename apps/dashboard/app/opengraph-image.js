...
export const alt = "Kepler - The only one Discord Bot";
 ...
 return new ImageResponse(
  (
   ...
   >
    ...
    >
     Kepler will not only keep your server entertained but also assist you with moderation and many other things!
    </div>
   </div>
  ),
  {
