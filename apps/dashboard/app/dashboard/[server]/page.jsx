...
import { getServer, getGuildPreview, getGuildMember } from "@kepler/util/functions/guild";
import { fillMissingDates } from "@kepler/util/functions/util";
    ...
    <div className="mt-6 flex flex-col justify-start gap-6 [flex:2_1_0%] lg:mt-0">
     <Block>
      ...
      {/* {guild.publicPage ? (
       ...
       <span className="mx-auto whitespace-nowrap sm:ml-auto sm:mr-0">Designed by n0step_</span>
      )} */}
     </Block>
     <Block>
