    ...
    <Block className="mb-4 !py-3">
     ...
     <div className="my-2 flex flex-row flex-wrap gap-2">
      ...
      <Switch // prettier
       ...
       onChange={() => setActions(actions.some((action) => action.type === 1) ? actions.filter((action) => action.type !== 1) : [...actions, { type: 1, metadata: { custom_message: "Message blocked due to containing an invite link. Rule added by Kepler" } }])}
      />
     </div>
